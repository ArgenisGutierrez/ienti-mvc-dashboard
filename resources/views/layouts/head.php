        ...
        <div class="dropdown-menu dropdown-menu-end shadow-lg">
          <div class="dropdown-item">
            <div class="d-flex py-2 border-bottom">
              <img src="<?php echo APP_URL?>images/user.png" class="img-3x me-3 rounded-3" alt="Admin Dashboards" />
              <div class="m-0">
          ...
          <div class="dropdown-item">
            <div class="d-flex py-2 border-bottom">
              <img src="<?php echo APP_URL?>images/user2.png" class="img-3x me-3 rounded-3" alt="Admin Dashboards" />
              <div class="m-0">
          ...
          <div class="dropdown-item">
            <div class="d-flex py-2">
              <img src="<?php echo APP_URL?>images/user1.png" class="img-3x me-3 rounded-3" alt="Admin Dashboards" />
              <div class="m-0">
